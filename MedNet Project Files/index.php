	...
	<header id="header">
		<div class="inner">
			...
			<nav id="nav">
				...
				<div class="dropdown">
					<div class="projects">
						<button><!--<i id="icon1" class="fas fa-user"></i>--><?php if (isset($_SESSION['user_id'])) echo $_SESSION['user_name']; ?></button>
						<ul>
		...
		<div class="inner">
			...
			<div class="flex flex-2">
				...
				<article>
					...
					<footer>
						<a href="web/appointment.php" class="button special">More</a>
					</footer>
				</article>
			</div>
		</div>
